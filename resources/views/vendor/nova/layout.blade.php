...
<body class="min-w-site bg-40 text-90 font-medium min-h-full">
    <div id="nova">
        <div v-cloak class="flex min-h-screen">
            ...
            <!-- Content -->
            <div class="content">
                <div class="flex items-center justify-between relative shadow h-header bg-white z-20 px-view">
...
{{--                    @endif--}}
                    ...
                    <div class="flex flex-1 mt-4 align-content-end justify-end">
    ...
    <script src="{{mix('vendor/nova/custom/app.js')}}"></script>
    <!-- Build Nova Instance -->
    <script>
