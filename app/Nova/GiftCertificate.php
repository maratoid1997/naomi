...
class GiftCertificate extends Resource
{
     ...
     * @var string
     */
    public static $model = \App\Models\Orders\GiftCertificate::class;
    ...
    public function fields(Request $request)
    {
        return [
            ...
            Text::make('Code')->rules('nullable','unique:gift_certificates,code,'.$request->resourceId),
            AdvancedNumber::make('Price')->rules('required'),
            DateTime::make('Start date')->rules('required'),
            DateTime::make('End date')->rules('required','after:start_date'),
            Text::make('Quantity')->rules('nullable')->onlyOnForms()->hideWhenUpdating(),
        ];
    }
