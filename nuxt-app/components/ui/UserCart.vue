<template>
    <div class="user-cart">
        <nuxt-link class="user-cart__icon" :to="$localePath('/cart')">
            ...
            <div class="user-cart__items-count">
                <span>{{ cartItemsCount }}</span>
            </div>
        </nuxt-link>
        <nuxt-link class="user-cart__info" :to="$localePath('/cart')">
            <p class="user-cart__label">{{ $t("my_cart") }}</p>
            <p class="user-cart__total" v-html="$calculatePrice(cartTotal)"></p>
        </nuxt-link>
    </div>
</template>
